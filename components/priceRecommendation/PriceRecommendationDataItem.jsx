        ...
        >
            ...
            >
                <View className="flex-row justify-between mb-3">
                    <Text className="text-gray-700 font-bold">Base Egg Price</Text>
                ...
                <View className="flex-row justify-between mb-3">
                    <Text className="text-gray-700 font-bold">Carton Price With Transportation</Text>
                    <Text className="text-lime-800 font-bold">₹{item.cartonPriceWithTransportation}</Text>
                </View>
                <View className="flex-row justify-between mb-3">
                    <Text className="text-gray-700 font-bold">Mahashakti Premium Charge</Text>
